...
public class ParamsCryptoRequestBodyAdvice implements RequestBodyAdvice {
    ...
    public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter parameter,
        ...
        return new DecryptHttpInputMessage(inputMessage, paramsCryptoProvider);
    }
    ...
    static class DecryptHttpInputMessage implements HttpInputMessage {
        ...
        public InputStream getBody() throws IOException {
            ...
            String decryptContent = paramsCryptoProvider.decrypt(content);
